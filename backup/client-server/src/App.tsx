  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 overflow-hidden">
      ...
      <header className="h-14 flex items-center justify-between px-5 bg-white border-b border-gray-100 flex-shrink-0">
        ...
        {/* Right actions */}
        <div className="w-52 flex justify-end gap-2">
          {tab === 'roadmap' && (
            <button
              onClick={() => openStream()}
          ...
          <button
            onClick={() => signOut()}
            className="text-xs font-medium text-gray-400 hover:text-gray-600 bg-transparent border-0 cursor-pointer px-2 py-1.5"
            title="Sign out"
          >
            Sign out
          </button>
